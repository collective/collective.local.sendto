...
class CollectiveLocalSendtoLayer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        """Set up Zope."""
        # Load ZCML
        self.loadZCML(package=collective.local.sendto,
                      name='testing.zcml')
        z2.installProduct(app, 'collective.local.sendto')
    ...
    def tearDownZope(self, app):
        """Tear down Zope."""
        z2.uninstallProduct(app, 'collective.local.sendto')


FIXTURE = CollectiveLocalSendtoLayer(
    name="FIXTURE"
    )
